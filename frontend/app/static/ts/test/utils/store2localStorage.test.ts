...
import {
  ...
  move2end,
  removeOldestAndAdd,
} from "../../src/utils/store2localStorage";
import { createMockLocalStorage } from "../testTools";

describe("test move2end", () => {
  const validKeywordsAry: Array<string> = [
    "Banana",
    "Orange",
    "Apple",
    "Mango",
...
describe("test removeOldestAndAdd", () => {
  ...
  test("正常動作", () => {
    ...
    expect(retVal).toBe(
      "word2,word3,word4,word5,word6,word7,word8,word9,word10,Mango",
    );
  });
});
 ...
 */
function testStore2localStorage(
